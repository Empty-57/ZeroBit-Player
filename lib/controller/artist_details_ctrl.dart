...
class ArtistDetailsController extends GetxController with DetailsPageBaseController {
  final List<String> pathList;
  ArtistDetailsController({required this.pathList});
  ...
  void onInit() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      loadDetailsData(pathList, OperateArea.artistList);
    });
  }
