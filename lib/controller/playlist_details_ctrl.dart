...
class PlayListDetailsController extends GetxController with DetailsPageBaseController {
  final List<String> pathList;
  PlayListDetailsController({required this.pathList});
  ...
  void onInit() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      loadDetailsData(pathList, OperateArea.playList);
    });
  }
