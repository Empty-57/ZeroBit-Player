...
abstract class RustLibApi extends BaseApi {
  ...
  Future<BASS_DX8_PARAMEQ> crateApiBassBassFuncBassDx8ParameqDefault();
  ...
  Future<void> crateApiMusicTagToolEditEmbeddedLyric({
    required String path,
  ...
  Future<Float32List?> crateApiBassGetChanData();
  ...
  Future<double> crateApiBassGetLen();
  ...
  Future<void> crateApiBassSwitchExclusiveMode({required bool exclusive});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<BASS_DX8_PARAMEQ> crateApiBassBassFuncBassDx8ParameqDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bass_dx_8_parameq,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiBassBassFuncBassDx8ParameqDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBassBassFuncBassDx8ParameqDefaultConstMeta =>
      const TaskConstMeta(debugName: "bass_dx_8_parameq_default", argNames: []);
  ...
  Future<void> crateApiMusicTagToolEditEmbeddedLyric({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMusicTagToolEditEmbeddedLyricConstMeta,
  ...
  TaskConstMeta get kCrateApiMusicTagToolEditEmbeddedLyricConstMeta =>
      const TaskConstMeta(
        debugName: "edit_embedded_lyric",
        argNames: ["path", "lyric"],
      );
  ...
  Future<Float32List?> crateApiBassGetChanData() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBassGetChanDataConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBassGetChanDataConstMeta =>
      const TaskConstMeta(debugName: "get_chan_data", argNames: []);
  ...
  Future<String?> crateApiMusicTagToolGetEmbeddedLyric({required String path}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMusicTagToolGetEmbeddedLyricConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMusicTagToolGetEmbeddedLyricConstMeta =>
      const TaskConstMeta(debugName: "get_embedded_lyric", argNames: ["path"]);
  ...
  Future<double> crateApiBassGetLen() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBassGetLenConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBassGetLenConstMeta =>
      const TaskConstMeta(debugName: "get_len", argNames: []);
  ...
  Future<void> crateApiBassSetEqParams({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_i_32(freCenterIndex, serializer);
        ...
        constMeta: kCrateApiBassSetEqParamsConstMeta,
        argValues: [freCenterIndex, gain],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiBassSetEqParamsConstMeta => const TaskConstMeta(
    debugName: "set_eq_params",
    argNames: ["freCenterIndex", "gain"],
  );
  ...
  Future<void> crateApiBassSetSpeed({required double speed}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBassSetSpeedConstMeta,
        argValues: [speed],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBassSetSpeedConstMeta =>
  ...
  Future<void> crateApiBassSwitchExclusiveMode({required bool exclusive}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBassSwitchExclusiveModeConstMeta,
        argValues: [exclusive],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBassSwitchExclusiveModeConstMeta =>
      const TaskConstMeta(
        debugName: "switch_exclusive_mode",
        argNames: ["exclusive"],
      );
  ...
  BASS_DX8_PARAMEQ dco_decode_bass_dx_8_parameq(dynamic raw) {
    ...
    return BASS_DX8_PARAMEQ(
      fCenter: dco_decode_f_32(arr[0]),
      fBandwidth: dco_decode_f_32(arr[1]),
      fGain: dco_decode_f_32(arr[2]),
    );
  }
  ...
  BASS_DX8_PARAMEQ sse_decode_bass_dx_8_parameq(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_fCenter = sse_decode_f_32(deserializer);
    var var_fBandwidth = sse_decode_f_32(deserializer);
    var var_fGain = sse_decode_f_32(deserializer);
    return BASS_DX8_PARAMEQ(
      fCenter: var_fCenter,
  ...
  void sse_encode_bass_dx_8_parameq(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_f_32(self.fCenter, serializer);
    sse_encode_f_32(self.fBandwidth, serializer);
    sse_encode_f_32(self.fGain, serializer);
  }
